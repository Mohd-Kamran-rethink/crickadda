  ...
  <header class="darker_theme">
          ...
          <div class="sidebrand-contain">
            <div class="site_logo">
              <a id="logo-container" href="#" class="brand-logo">
                <img class="menu_icon ng-star-inserted"src="{{ asset('storage/Banners/' . $logo->filename) }}">
              </a>
            </div>
          </div>
                ...
                <ul id="dropdown" class="dropdown-content"
                  ...
                  <li class="ng-star-inserted">
                    <div>
                      <div class="theme-slider-wrapper">
                        <span>Theme</span>
                        <form novalidate="" action="#" class="theme-radio ng-untouched ng-pristine ng-valid">
                          <label>
    ...
    <ul id="nav-mobile" class="sidenav" style="transform: translateX(-105%);">
      <div class="search-box">
        <div class="search">
          <input list="list" type="text" placeholder="Search Market.." id="list" autocomplete="off" class="search-txt">
        </div>
      </div>
      <div class="list-cont">
      ...
      <div routerlink="/casinos"
        class="d-flex align-items-center justify-content-between market-border backGround_gradient" tabindex="0">
        <label>
          <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg">
          <span class="getColor">Casinos</span>
        </label>
      </div>
      <div class="d-flex align-items-center justify-content-between market-border backGround_gradient ng-star-inserted">
        <label>
          <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg">
      ...
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Soccer Fixtures </label>
      ...
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Horse Racing </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Horse Race Todays Card </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Greyhound Racing </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Greyhound Todays Card </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> American Football </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Baseball </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Basketball </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      ...
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Gaelic Games </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      ...
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Mixed Martial Arts </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Motor Sport </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Rugby League </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
      <li class="lc-1 ng-star-inserted">
        <div class="d-flex align-items-center justify-content-around">
          <label>
            <img alt="Casino" class="top_bar_images" src="NewTheme/images/Casino.svg"> Rugby Union </label>
          <!-- <img src="NewTheme/images/arrow.svg" alt="" class="dwn-arrow"> -->
        </div>
        <ul data-check="1" class="lc-2"></ul>
      </li>
    ...
    <div class="categories-home">
      <ul class="nav mobile-nav mobile-nav home-slider mobile-home-scroll-content">
        <li class="item" tabindex="0">
          <a href="#" id="navMobileBetGamesTV" name="navMobileBetGamesTV" class="betgamestv item-nav">
        ...
        <li class="item">
          <a id="navMobileBetGamesTV" name="navMobileBetGamesTV" class="betgamestv item-nav">
            <img alt="Sports Book" class="top_bar_images" src="NewTheme/images/SPORTSBOOK12.svg"> SportBook1 </a>
        </li>
        <li class="item">
          <a id="navMobileLiveSports" name="navMobileLiveSports" href="#" class="livesports item-nav">
        ...
        <li class="item">
          <a id="navMobileSports" name="navMobileSports" href="#" class="sports item-nav">
            <img alt="Cricket" class="top_bar_images" src="NewTheme/images/Cricket.svg"> Fantasy Games </a>
        </li>
      </ul>
    </div>
                ...
                <div class="footer-nav max-footer-width">
                  <div>
                    <div class="license-column-holder">
                      <div style="display: flex; justify-content: center;" class="ng-star-inserted">
                        <a class="btn_wrapper special_border">
                          <button type="button" class="button-1 for-img">
                            ...
                            <div style="display: contents;">
                              <img alt="angle icon" style="width: 6px; margin-right: 0; position: absolute; right: 30%;"
                      ...
                      <div class="tutorials">
                        <span class="special_border">
                          <div class="tutorial-btn">
                            ...
                            <div class="angle">
                              <img alt="angle icon" style="width: 6px; margin-right: 0;" src="NewTheme/images/angle.svg">
                              <img alt="angle icon" style="width: 6px; margin-right: 0;" src="NewTheme/images/angle.svg">
                            </div>
                          </div>
                        </span>
                      ...
                      <div class="payment-img-holder">
                        <div class="row" style="justify-content: space-around;">
                          <img alt="INB" class="row-images1" src="NewTheme/images/INB.svg">
                          <img alt="UPI" class="row-images1" src="NewTheme/images/UP.svg">
                          <img alt="Visa" class="row-images1" src="NewTheme/images/VISA.svg">
                          <img alt="Master" class="row-images1" src="NewTheme/images/MASTER.svg">
                          <img alt="Paytm" class="row-images1" src="NewTheme/images/PAYT.svg">
                          <img alt="Gpay" class="row-images1" src="NewTheme/images/GPY.svg">
                          <img alt="Bank Trasnfer" class="row-images1" src="NewTheme/images/BNKTRANSFER.svg">
                        </div>
                        <div class="row" style="margin-top: 8px; justify-content: space-around;">
                          <img alt="One Rupee" class="row-images1" src="NewTheme/images/ONERUPEE.svg">
                          <img alt="Jeton" class="row-images1" src="NewTheme/images/JETON.svg">
                          <img alt="Skrill" class="row-images1" src="NewTheme/images/SKRILL.svg">
                          <img alt="Jio Money" class="row-images1" src="NewTheme/images/JIO.svg">
                          <img alt="IMPS" class="row-images1" src="NewTheme/images/IMP.svg">
                          <img alt="BBL" class="row-images1" src="NewTheme/images/BBL.svg">
                          <img alt="Net Banking" class="row-images1" src="NewTheme/images/NETBANK.svg">
                        </div>
                      </div>
                      <div class="footer-items">
                        <div class="footer-text">
                          <ul class="link-list">
                            ...
                            <li>
                              <a href="https://app.cricadda.com/terms-and-conditions">Terms and Conditions</a>
                            </li>
                            <li>
                              <a href="https://app.cricadda.com/aml-policy">AML Policy</a>
                            </li>
                          </ul>
                        </div>
                        <div class="footer-text">
                          <ul class="link-list">
                            <li>
                              <a href="https://app.cricadda.com/kyc-policy">KYC Policy</a>
                            </li>
                            <li>
                              <a href="https://app.cricadda.com/responsible-gaming">Responsible Gambling</a>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="footer">
                        <div class="max-footer-width">
                          <div class="footer-grid-layout">
                            <div class="curacao">
                              <div class="site-gaming-register-text vmiddle" style="color: #848484 !important;">
                                This website is operated by Seven Investments America N.V., registered in Curaçao under the number 152581, with the address at Zuikertuintjeweg Z/N (Zuikertuin Tower), Curaçao <br><br>
                                The transactions are processed by Seven Investments LTD registered with the number 12391820, with head office at Kemp House 160 City Road, London, United Kingdom. For the purpose of processing payments via Paysafe Group including but not limited to Neteller and Skrill, the transaction processing entity shall be Seven Investments America N.V., registered in Curaçao under the number 152581, with the address at Zuikertuintjeweg Z/N (Zuikertuin Tower), Curaçao..<br/>
